...
```
                                           ...
                                           ,,                                                  ,,          
MMP""MM""YMM   .M"""bgd                    db             mm         .g8"""bgd               `7MM          
P'   MM   `7  ,MI    "Y                                   MM       .dP'     `M                 MM          
     MM       `MMb.      ,p6"bo `7Mb,od8 `7MM `7MMpdMAo.mmMMmm     dM'       ` ,pW"Wq.    ,M""bMM  .gP"Ya  
     MM         `YMMNq. 6M'  OO   MM' "'   MM   MM   `Wb  MM       MM         6W'   `Wb ,AP    MM ,M'   Yb 
     MM mmmmm .     `MM 8M        MM       MM   MM    M8  MM mmmmm MM.        8M     M8 8MI    MM 8M"""""" 
     MM       Mb     dM YM.    ,  MM       MM   MM   ,AP  MM       `Mb.     ,'YA.   ,A9 `Mb    MM YM.    , 
   .JMML.     P"Ybmmd"   YMbmd' .JMML.   .JMML. MMbmmd'   `Mbmo      `"bmmmd'  `Ybmd9'   `Wbmd"MML.`Mbmmd' 
                                                MM                                                         
                                              .JMML.                                                       
